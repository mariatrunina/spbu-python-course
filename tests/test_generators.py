...
from project.generators import fetch_rgba_by_index, get_kth_prime_number, COMBINATION_LIMIT
...
def test_fetch_rgba_multiple_cases(index: int, expected_rgba: Tuple[int, int, int, int]) -> None:
    
    assert fetch_rgba_by_index(index) == expected_rgba

@pytest.mark.parametrize(
    "k, expected_prime",
    [(1, 2), (2, 3), (5, 11), (10, 29), (100, 541), (1000, 7919)]
)
